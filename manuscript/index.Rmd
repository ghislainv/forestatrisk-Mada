...
Target journals (selection): _Conservation Biology_ (IF: 5.89), _Biological Conservation_ (IF: 4.66), _Environmental Research Letters_ (IF: 4.54), _Landscape Ecology_ (IF: 3.83).
